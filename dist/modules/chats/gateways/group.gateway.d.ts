...
export declare class GroupGateway {
    ...
    constructor(memberService: GroupMemberService, messageService: GroupMessageService, chatService: GroupService, fileService: FilesService, userService: UserService, websocketService: WebsocketService);
    wss: Server;
