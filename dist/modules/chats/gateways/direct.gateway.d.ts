...
export declare class DirectGateway {
    ...
    constructor(memberService: DirectMemberService, messageService: DirectMessageService, chatService: DirectService, fileService: FilesService, userService: UserService, websocketsService: WebsocketService);
    wss: Server;
