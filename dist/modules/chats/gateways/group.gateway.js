...
], GroupGateway.prototype, "wss", void 0);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, typeof (_a = typeof group_1.SubscribeChatsDto !== "undefined" && group_1.SubscribeChatsDto) === "function" ? _a : Object]),
    __metadata("design:returntype", Promise)
], GroupGateway.prototype, "handleSubscribingChat", null);
__decorate([
    websockets_1.SubscribeMessage(events_1.groupChatServerEvents.CREATE_MESSAGE),
    __param(0, websockets_1.ConnectedSocket()),
    __param(1, websockets_1.MessageBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_b = typeof group_1.CreateMessageDto !== "undefined" && group_1.CreateMessageDto) === "function" ? _b : Object]),
    __metadata("design:returntype", Promise)
], GroupGateway.prototype, "handleCreatingMessage", null);
__decorate([
    websockets_1.SubscribeMessage(events_1.groupChatServerEvents.CREATE_CHAT),
    __param(0, websockets_1.ConnectedSocket()),
    __param(1, websockets_1.MessageBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_c = typeof group_1.CreateChatDto !== "undefined" && group_1.CreateChatDto) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
], GroupGateway.prototype, "handleCreatingChat", null);
__decorate([
    websockets_1.SubscribeMessage(events_1.groupChatServerEvents.ADD_MEMBER),
    __param(0, websockets_1.ConnectedSocket()),
    __param(1, websockets_1.MessageBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_d = typeof group_1.AddMemberDto !== "undefined" && group_1.AddMemberDto) === "function" ? _d : Object]),
    __metadata("design:returntype", Promise)
], GroupGateway.prototype, "handleAddingMember", null);
__decorate([
    websockets_1.SubscribeMessage(events_1.groupChatServerEvents.KICK_MEMBER),
    __param(0, websockets_1.ConnectedSocket()),
    __param(1, websockets_1.MessageBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_e = typeof group_1.KickMemberDto !== "undefined" && group_1.KickMemberDto) === "function" ? _e : Object]),
    __metadata("design:returntype", Promise)
], GroupGateway.prototype, "handleRemovingMember", null);
__decorate([
    websockets_1.SubscribeMessage(events_1.groupChatServerEvents.LEAVE),
    __param(0, websockets_1.ConnectedSocket()),
    __param(1, websockets_1.MessageBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_f = typeof group_1.LeaveChatDto !== "undefined" && group_1.LeaveChatDto) === "function" ? _f : Object]),
    __metadata("design:returntype", Promise)
], GroupGateway.prototype, "handleLeavingChat", null);
__decorate([
    websockets_1.SubscribeMessage(events_1.groupChatServerEvents.READ_MESSAGE),
    __param(0, websockets_1.ConnectedSocket()),
    __param(1, websockets_1.MessageBody()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, typeof (_g = typeof group_1.ReadMessageDto !== "undefined" && group_1.ReadMessageDto) === "function" ? _g : Object]),
    __metadata("design:returntype", Promise)
], GroupGateway.prototype, "handleReadingMessage", null);
GroupGateway = __decorate([
    ...
    __metadata("design:paramtypes", [services_1.GroupMemberService,
        ...
        uploads_1.FilesService, typeof (_h = typeof users_1.UserService !== "undefined" && users_1.UserService) === "function" ? _h : Object, websocket_1.WebsocketService])
], GroupGateway);
exports.GroupGateway = GroupGateway;
//# sourceMappingURL=group.gateway.js.map